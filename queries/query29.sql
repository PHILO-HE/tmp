select
    overture.col_62986,
    overture.col_30973,
    if(dim_stock_ad.col_80043 in (34,35), 0, overture.rit)  as rit,
    if(dim_stock_ad.col_80043 in (34,35), 0, overture.col_47217) as col_47217,
    tbl_4121.col_17185,
    'null' as col_61860,
    'null' as col_55071,
    tbl_4121.col_8954,
    ...
    case
        ...
        when dim_stock_ad.col_80043 = 35 then 4
        when dim_stock_ad.col_80043 = 34 then 7
...
from
    ...
    left outer join
    (
        select id as col_64309, col_80043
        from tbl_9439
        where col_77093 = '20200831'
        and col_80043 in (34,35)
    )dim_stock_ad
    on tbl_4121.col_64309 = dim_stock_ad.col_64309
    left outer join
    (
...
group by
    overture.col_62986,
    overture.col_30973,
    if(dim_stock_ad.col_80043 in (34,35), 0, overture.rit) ,
    if(dim_stock_ad.col_80043 in (34,35), 0, overture.col_47217) ,
    tbl_4121.col_17185,
    tbl_4121.col_8954,
    tbl_4121.col_81773,
    tbl_5371.col_19590,
