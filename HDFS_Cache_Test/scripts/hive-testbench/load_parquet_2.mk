...
store_sales:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/store_sales.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table store_sales (18/24).'
store_returns:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/store_returns.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table store_returns (19/24).'
web_sales:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/web_sales.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table web_sales (20/24).'
web_returns:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/web_returns.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table web_returns (21/24).'
catalog_sales:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/catalog_sales.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table catalog_sales (22/24).'
catalog_returns:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/catalog_returns.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table catalog_returns (23/24).'
inventory:
	@hive -i settings/load-partitioned.sql                   -f ddl-tpcds/bin_partitioned/inventory.sql 	          -d DB=tpcds_bin_partitioned_parquet_2                   -d SCALE=2 	          -d SOURCE=tpcds_text_2                   -d FILE=parquet 2> /dev/null 1> /dev/null && echo 'Optimizing table inventory (24/24).'
